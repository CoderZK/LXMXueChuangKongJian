...
- (void)_setupSubviews
{
    ...
    _inputTextView.placeHolder = @"聊些什么吧...";
...
{
    if (_moreView == nil) {
        _moreView = [[EaseChatBarMoreView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_toolbarView.frame)+10, self.frame.size.width, 80) type:self.chatBarType];
