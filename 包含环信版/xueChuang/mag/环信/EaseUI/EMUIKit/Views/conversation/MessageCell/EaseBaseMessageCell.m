...
- (void)layoutSubviews
{
    ...
    _bubbleView.textLabel.textColor = self.model.isSender ? UIColor.whiteColor : CharacterDarkColor;
...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    if (model.avatarURLPath) {
        [self.avatarView sd_setImageWithURL:[NSURL URLWithString:[LxmURLDefine getPicImgWthPicStr:model.avatarURLPath]] placeholderImage:[UIImage imageNamed:@"moren"]];
    } else {
        self.avatarView.image = [UIImage imageNamed:@"moren"];
    }
