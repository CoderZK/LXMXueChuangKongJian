...
@property (strong , nonatomic) LxmCanListModel *detailModel;
@property (strong , nonatomic) LxmHuanXinModel *userModel;
@property (strong , nonatomic) LxmHuanXinModel *myUserModel;
