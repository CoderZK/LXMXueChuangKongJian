...
@interface LxmAroundVC ()<LxmAroundBottomViewDelegate>
@property (nonatomic , assign)LxmAroundVC_type type;
...
- (void)viewDidLoad {
    ...
    if (self.type != LxmAroundVC_type_mine) {
        [self initBottomView];
    }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LxmAroundModel * model = [self.dataArr objectAtIndex:indexPath.row];
    cell.model = model;
    return cell;
}
