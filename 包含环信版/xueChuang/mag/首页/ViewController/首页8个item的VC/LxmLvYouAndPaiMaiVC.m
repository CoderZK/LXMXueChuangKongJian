...
@implementation LxmLvYouAndPaiMaiVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LxmArticleModel * model = [self.dataArr objectAtIndex:indexPath.row];
    cell.model = model;
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LxmArticleModel * model = [self.dataArr objectAtIndex:indexPath.row];
    LxmLvAndPaiMaiDetailVC *  vc = [[LxmLvAndPaiMaiDetailVC alloc] initWithTableViewStyle:UITableViewStyleGrouped typeModel:model type:self.typeModel.ID];
    __weak typeof(self)safe_self = self;
