...
@interface LxmAddFriendVC ()<UISearchResultsUpdating, UISearchControllerDelegate,LxmAddFriendCellDelegate,SNYQRCodeVCDelegate>
...
- (void)LxmAddFriendCellBtnClick:(LxmAddFriendCell *)cell{
    ...
    LxmAddFriendSendMessageVC * vc = [[LxmAddFriendSendMessageVC alloc] init];
