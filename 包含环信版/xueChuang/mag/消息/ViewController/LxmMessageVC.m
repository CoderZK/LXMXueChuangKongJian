...
@interface LxmMessageVC ()<LxmMineNavItemViewDelegate>
@property (nonatomic , strong)UIScrollView * scrollView;
@property (nonatomic , strong)LxmMineNavItemView * navView;
@property (nonatomic , strong)LxmMessageReceiveVC * receiveVC;
@property (nonatomic , strong)LxmFriendVC * friendVC;
@end
...
- (void)viewDidLoad {
    ...
    self.receiveVC = [[LxmMessageReceiveVC alloc] init];
    ...
    self.friendVC = [[LxmFriendVC alloc] initWithTableViewStyle:UITableViewStyleGrouped];
