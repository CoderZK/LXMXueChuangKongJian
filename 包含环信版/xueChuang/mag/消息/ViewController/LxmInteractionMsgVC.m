...
@implementation LxmInteractionMsgVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch ([model.type intValue]) {
        ...
        {
            LxmTaskDetailVC *taskDetailViewController = [LxmTaskDetailVC new];
        ...
        {
            LxmLvAndPaiMaiDetailVC *  vc = [[LxmLvAndPaiMaiDetailVC alloc] initWithTableViewStyle:UITableViewStyleGrouped typeModel:nil type:nil];
...
- (void)setDataModel:(LxmFindInterMsgModel *)dataModel{
    ...
    self.nameLab.text = [NSString stringWithFormat:@"%@%@",dataModel.otherUserNickname,dataModel.title];
