...
@property (nonatomic , strong)LxmLvYouAndPaiMaiVC * zixunVC;
@property (nonatomic , strong)LxmAroundVC * aroundVC;
@property (nonatomic , strong)LxmLvYouAndPaiMaiVC * lvYouVC;
@property (nonatomic , strong)LxmLvYouAndPaiMaiVC * paMaiVC;
@end
...
- (void)viewDidLoad {
    ...
    zixunModel.ID = @10;
    self.zixunVC = [[LxmLvYouAndPaiMaiVC alloc] initWithTableViewStyle:UITableViewStylePlain currentModel:zixunModel];
    ...
    self.aroundVC = [[LxmAroundVC alloc] initWithTableViewStyle:UITableViewStylePlain type:LxmAroundVC_type_mine];
    ...
    lvYouModel.ID = @6;
    self.lvYouVC =  [[LxmLvYouAndPaiMaiVC alloc] initWithTableViewStyle:UITableViewStylePlain currentModel:lvYouModel];
    ...
    paMaiVCModel.ID = @8;
    self.paMaiVC =  [[LxmLvYouAndPaiMaiVC alloc] initWithTableViewStyle:UITableViewStylePlain currentModel:paMaiVCModel];
