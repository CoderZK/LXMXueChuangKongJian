...
- (void)loadShareData{
    if (ISLOGIN&&SESSION_TOKEN) {
        [LxmNetworking networkingPOST:[LxmURLDefine app_shareInfo] parameters:@{@"type":@6,@"id":@([LxmTool ShareTool].userModel.userId)} returnClass:nil success:^(NSURLSessionDataTask *task, id responseObject) {
