...
@interface LxmPublishAbleDanVC ()<LxmPublishImgViewDelegate,UITextFieldDelegate,LxmLeftLabRightNumViewDelegate,LxmPublishAbleOtherInfoViewDelegate,UITextViewDelegate>
...
@implementation LxmPublishAbleDanVC
...
- (void)publishBtnClick{
    ...
    if (self.otherInfoView.priceView.numTF.text.intValue == 0) {
    ...
    dic[@"money"] = @(self.otherInfoView.priceView.numTF.text.intValue);
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    if (textField == self.otherInfoView.priceView.numTF) {
        if (self.otherInfoView.priceView.numTF.text.intValue == 0) {
        ...
        }else if (self.otherInfoView.priceView.numTF.text.intValue > 9999) {
            ...
            if (self.otherInfoView.danweiView.rightTF.text.length == 0 ) {
                ...
                self.otherInfoView.priceLab.text = [NSString stringWithFormat:@"￥%d/%@",self.otherInfoView.priceView.numTF.text.intValue,self.otherInfoView.danweiView.rightTF.text];
            }
        }
    }
