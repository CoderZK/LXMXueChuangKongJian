...
@interface LxmLoginAndRegisterVC ()
...
//游客登录
- (void)youKELogin {
    LxmAbleVC * vc = [[LxmAbleVC alloc] initWithTableViewStyle:UITableViewStyleGrouped];
    vc.isyouke = YES;
...
- (void)loginSuccess {
    NSString *username = @([LxmTool ShareTool].userModel.userId).stringValue;
