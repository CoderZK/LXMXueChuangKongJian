...
- (void)viewDidLoad {
    ...
    NSArray *className = @[@"LxmHomeVC",@"LxmAbleVC",@"",@"LxmMessageVC",@"LxmMineVC"];
...
- (void)publish {
    if (ISLOGIN) {
        BaseNavigationController * nav = [[BaseNavigationController alloc] initWithRootViewController:[[LxmPublishVC alloc] init]];
