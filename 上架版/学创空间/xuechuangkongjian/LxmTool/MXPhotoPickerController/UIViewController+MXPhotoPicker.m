...
#define NSArrayObjectMaybeNil(__ARRAY__, __INDEX__) ((__INDEX__ >= [__ARRAY__ count]) ? nil : [__ARRAY__ lxm_object1AtIndex:__INDEX__])
                        ...
                        completion:(MXPhotoPickerSingleBlock)completion
{
    ...
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        [otherButtonTitles lxm_add1Object:kCameraTitle];
    }
    
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypePhotoLibrary]) {
        [otherButtonTitles lxm_add1Object:kPhotoLibraryTitle];
    }
