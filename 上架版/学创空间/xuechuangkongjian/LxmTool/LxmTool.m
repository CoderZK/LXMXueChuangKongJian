...
- (void)setXiaDanName:(NSString *)xiaDanName {
    [[NSUserDefaults standardUserDefaults] setObject:xiaDanName forKey:@"xiaDanName"];
       [[NSUserDefaults standardUserDefaults] synchronize];
}


- (NSString *)xiaDanName {
     return [[NSUserDefaults standardUserDefaults] objectForKey:@"xiaDanName"];
    
}


- (void)setXiaDanPhone:(NSString *)xiaDanPhone {
    [[NSUserDefaults standardUserDefaults] setObject:xiaDanPhone forKey:@"xiaDanPhone"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

- (NSString *)xiaDanPhone {
    return [[NSUserDefaults standardUserDefaults] objectForKey:@"xiaDanPhone"];
}


- (void)setXiaDanAddress:(NSString *)xiaDanAddress {
    [[NSUserDefaults standardUserDefaults] setObject:xiaDanAddress forKey:@"xiaDanAddress"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}


- (NSString *)xiaDanAddress {
    return [[NSUserDefaults standardUserDefaults] objectForKey:@"xiaDanAddress"];
}
